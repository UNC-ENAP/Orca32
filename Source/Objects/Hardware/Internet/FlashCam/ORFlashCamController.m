...
- (IBAction) traceTypeAction:(id)sender
{
    ...
    [model setTraceType:[sender indexOfSelectedItem]];
}
...
{
  if([sender intValue] != [model chanEnabled:[[sender selectedCell] tag]])
...
{
    if([sender intValue] != [model poleZero:[[sender selectedCell] tag]])
        [model setPoleZero:[[sender selectedCell] tag] withValue:[sender intValue]];
}

- (IBAction) shapeTimeAction:(id)sender
{
    if([sender intValue] != [model shapeTime:[[sender selectedCell] tag]])
        [model setShapeTime:[[sender selectedCell] tag] withValue:[sender intValue]];
}
